...
// examples/test-case/test-case.html
var test_case_default = '<div class="test-case">\n  <!-- Add Content Here For Test Case !-->\n</div>\n';

// examples/test-case/test-case.css
var test_case_default2 = ".test-case {}\n";

// examples/test-case/test-case.js
var createInstance = function(tpl, $3) {
  return {};
};
var onCreated = (tpl) => {
};
...
var TestCase = createComponent({
  tagName: "test-case",
  template: test_case_default,
  css: test_case_default2,
  createInstance,
  onCreated,
  onDestroyed,
  events
