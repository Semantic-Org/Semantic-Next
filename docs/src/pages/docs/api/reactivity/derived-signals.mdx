...
Creates a new signal derived from a single source signal, recomputing when the source changes. Also available as the instance method [`source.derive`](#sourcederive).
