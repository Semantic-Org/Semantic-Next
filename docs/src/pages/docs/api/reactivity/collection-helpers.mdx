...
methods: [setProperty, replaceItem, removeItem, getIDs, getID, hasID, getItemIndex, getItem, setArrayProperty]
...
<PlaygroundExample id="reactive-set-array-property" direction="horizontal"></PlaygroundExample>
