...
> **Count Usage** `count()` is preferred although the [Query object](/docs/api/query/basic#the-query-object) is `array-like` and `length` will also work. If it's really important to you -- you can still do that.
...
### Returns
`number` - The number of elements in the [Query object](/docs/api/query/basic#the-query-object).
...
### Returns
`number` - The index of the first element within the [Query object](/docs/api/query/basic#the-query-object) relative to its sibling elements, or -1 if not found.
...
### Returns
A new [Query object](/docs/api/query/basic#the-query-object) containing the reversed elements.
...
### Returns
A new [Query object](/docs/api/query/basic#the-query-object) containing the sliced elements.
...
### Returns
[Query object](/docs/api/query/basic#the-query-object) containing the combined elements with duplicates removed.
