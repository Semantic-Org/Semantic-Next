...
> **Important Note** Please be sure to read the [component documentation](/docs/guides/components) for more information on the usage of these helpers.

## component

Retrieves the [component instance](/docs/guides/components/create#instance) from a web component.
...
> **Access Component Methods** `component()` allows you to access methods and properties defined in the component's [`createComponent`](/docs/guides/components/create#definition-parts) function.

## settings

Initializes or updates [a component's settings](/docs/guides/components/rendering#settings) programmatically.
