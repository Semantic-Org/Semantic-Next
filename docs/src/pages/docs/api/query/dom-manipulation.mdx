...
### Returns
A new [Query object](/docs/api/query/basic#the-query-object) containing cloned elements.
...
### Returns
[Query object](/docs/api/query/basic#the-query-object) of the target elements (for chaining).
...
### Returns
[Query object](/docs/api/query/basic#the-query-object) containing the removed elements.
...
### Returns
[Query object](/docs/api/query/basic#the-query-object) containing the elements in reverse order.
