...
A new [Query object](/docs/api/query/basic#the-query-object) containing the clipping parent elements.
...
A new [Query object](/docs/api/query/basic#the-query-object) containing the offset parent elements.
...
A new [Query object](/docs/api/query/basic#the-query-object) containing the positioning parent elements.
...
A new [Query object](/docs/api/query/basic#the-query-object) containing the scroll parent element(s).
