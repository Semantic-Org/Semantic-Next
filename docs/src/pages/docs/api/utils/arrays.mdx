...
methods: [filterEmpty, first, firstMatch, findIndex, last, remove, inArray, range, sequence, moveItem, moveToFront, moveToBack, sum, unique, where, flatten, some, any, sortBy, groupBy, intersection, difference, uniqueItems]
icon: list
