...
methods: [copyText, getKeyFromEvent, getText, openLink, getJSON, getIPAddress]
icon: globe
...
> **Usage Note** This can be used on the server to load static assets like [templates](/templating) or [css](/docs/guides/components/styling)
### openLink
