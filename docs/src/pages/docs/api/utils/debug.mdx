...
| Name       | Type     | Default | Description |
|------------|----------|---------|-------------|
| layer      | string   | `''`    | The layer's public name, leading the production line (e.g. `sync`, `component`) — pre-filled as the pair's `namespace` |
