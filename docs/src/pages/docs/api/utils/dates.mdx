...
// A Temporal value prints in its own timeZoneId
console.log(formatDate(Temporal.ZonedDateTime.from('2023-05-15T23:30:00+09:00[Asia/Tokyo]'), 'LT')); // "11:30 pm"
console.log(formatDate(Temporal.Instant.from('2023-05-15T14:30:00Z'), 'LT')); // "2:30 pm" (an Instant has no zone, so UTC)
```
