...
methods: [isObject, isPlainObject, isString, isBoolean, isNumber, isArray, isBinary, isFunction, isPromise, isArguments, isDOM, isNode, isEmpty, isClassInstance, isSet, isMap]
icon: type
...
> **Instance Checking** `isMap()` uses `instanceof Map` to distinguish real Map instances from plain objects that might have similar method names.
