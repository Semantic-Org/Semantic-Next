...
methods: [keys, values, filterObject, mapObject, trackWrites, detectChanges, extend, assignInPlace, deepExtend, pick, arrayFromObject, get, proxyObject, onlyKeys, hasProperty, reverseKeys, weightedObjectSearch]
icon: box
