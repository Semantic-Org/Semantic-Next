...
|--------|-----|------------|
| `IS_TEMPORAL` | `'semantic-ui/Temporal'` | every kind, one read for the whole family |
...
```javascript
import { IS_DATE_TIME, IS_RANGE, IS_TEMPORAL } from '@semantic-ui/dates';

datetime('2026-09-06T14:30Z')[IS_DATE_TIME]; // true
dateRange('2026-09-01', '2026-09-07')[IS_RANGE]; // true
duration('PT1H')[IS_TEMPORAL]; // true, as is every kind
