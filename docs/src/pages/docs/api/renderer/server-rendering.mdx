...
The server renders a component to [Declarative Shadow DOM](https://developer.mozilla.org/en-US/docs/Web/API/Web_components/Using_shadow_DOM). The browser paints it before any JavaScript arrives, and the client later attaches reactivity to the DOM already on screen.

> **Usage Guide** See the [server rendering guide](/docs/guides/advanced/ssr) for setting server rendering up in a project.
