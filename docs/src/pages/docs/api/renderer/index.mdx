...
* [Lit Renderer](/docs/api/renderer/lit-renderer) - Core rendering engine based on Lit
* [Lit Directives](/docs/api/renderer/lit-directives) - Custom directives for reactive rendering
