...
methods: ['render', 'setData', 'evaluateExpression', 'evaluateTemplate', 'evaluateConditional', 'evaluateEach']
---
...
| literalValue | boolean | false   | Pass value as-is without auto-invoking functions |
...
The renderer supports various expression types in templates, for more information see the documentation on [template expression](/docs/guides/templates/expressions).
