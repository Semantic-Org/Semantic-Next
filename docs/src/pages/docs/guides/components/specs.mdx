...
Specs also create a stringified styling class in your [data context](docs/guides/components/rendering) `{uiClasses}` for `types` and `variations` parts of your spec that are related to styling, regardless of how that data is specified.
