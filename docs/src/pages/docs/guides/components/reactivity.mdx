...
> **Avoiding Reactivity** You can access reactive values with `peek` to avoid reactivity, and use `nonreactive` to control the reactivity of a function. For more information see [controlling reactivity](/docs/guides/reactivity/controls).
