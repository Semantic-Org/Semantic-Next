...
[Web Components](https://developer.mozilla.org/en-US/docs/Web/API/Web_components) are the right foundation for UI development: native to the browser, framework-agnostic, no compilation required. **But** vanilla Web Components force painful trade-offs: verbose boilerplate for basic state management, awkward Shadow DOM querying, manual dependency tracking, and imperative patterns that feel dated compared to modern frameworks.
...
<PlaygroundExample id="minimal" direction="horizontal"></PlaygroundExample>

### Framework Compatibility

Components work natively in React, Vue, Angular, or any framework that supports custom elements, because they *are* custom elements. No wrappers, no adapters, no framework-specific builds.
