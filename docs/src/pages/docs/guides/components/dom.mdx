...
The following example shows several elements with the class `matches` in the document's DOM, the web component's DOM, and the DOM slotted to a web component.
