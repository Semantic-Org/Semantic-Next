...
Semantic UI templates compile to an Abstract Syntax Tree (AST) for efficient rendering and targeted DOM updates. The declarative syntax handles [async operations](/docs/guides/templates/async), [loops](/docs/guides/templates/loops), [conditionals](/docs/guides/templates/conditionals), and [reactive expressions](/docs/guides/templates/expressions) with automatic dependency tracking.
...
> Templates compile once per component type and reuse the AST across instances. See [Templates & Data Context](/docs/guides/components/rendering) for integration details.

## Binding Data

Templates are bound to a [data context](/docs/guides/components/rendering) which is used for evaluating expressions.

You can think of the data context as "all the variables defined in the scope of your template".

When using the component framework these will come from sources in your component like their [settings](/docs/guides/components/settings), and [internal state](/docs/guides/components/state).

<PlaygroundExample id="advanced-color-picker" height="480"></PlaygroundExample>

## Template Features

### [Expressions](/docs/guides/templates/expressions)

Evaluate against the template's [data context](/docs/guides/components/rendering#data-context). Expressions are reactive - they re-evaluate when signals change.
...
### [Conditionals](/docs/guides/templates/conditionals)
...
### [Loops](/docs/guides/templates/loops)
...
### [Async Operations](/docs/guides/templates/async)
...
### [Reactivity Control](/docs/guides/templates/reactivity)
...
### [Slots](/docs/guides/templates/slots)
...
### [Global Helpers](/docs/guides/templates/helpers)
...
### [Subtemplates](/docs/guides/templates/subtemplates)
...
### [Snippets](/docs/guides/templates/snippets)
