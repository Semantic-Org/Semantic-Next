...
Async blocks handle promises directly in [templates](/docs/guides/templates). They create reactive contexts that automatically re-execute when reactive dependencies change.
...
Async blocks are [reactive contexts](/docs/guides/reactivity/reactions). Reactive contexts will rerun whenever [signals](/docs/guides/reactivity/signals) like [state](/docs/guides/components/state) or [settings](/docs/guides/components/settings) are modified.
...
> For more information about reactivity in [components](/docs/guides/components) see the [dedicated reactivity guide](/docs/guides/components/reactivity/#component-reactivity)
