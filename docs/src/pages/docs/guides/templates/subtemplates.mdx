...
If you would like to return the data context as an object [from an expression](/docs/guides/templates/expressions) you can do that using the `data` property.
