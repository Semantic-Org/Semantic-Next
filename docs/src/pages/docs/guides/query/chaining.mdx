...
Method chaining works because the `return` of many methods in Query is the [Query Object](/docs/api/query/) which can be passed through to another function.
...
- [`find()`](/docs/api/query/dom-traversal#find)
- [`filter()`](/docs/api/query/iterators#filter)
- [`parent()`](/docs/api/query/dom-traversal#parent)
- [`children()`](/docs/api/query/dom-traversal#children)
- [`next()`](/docs/api/query/dom-traversal#next)
- [`prev()`](/docs/api/query/dom-traversal#prev)
...
- [`addClass()`](/docs/api/query/css#addclass)
- [`removeClass()`](/docs/api/query/css#removeclass)
- [`toggleClass()`](/docs/api/query/css#toggleclass)
- [`attr()`](/docs/api/query/attributes#attr)
- [`css()`](/docs/api/query/css#css)
- [`html()`](/docs/api/query/content#html)
- [`text()`](/docs/api/query/content#text) (when setting text)
- [`on()`](/docs/api/query/events#on)
...
- [`text()`](/docs/api/query/content#text) (when getting text)
- [`html()`](/docs/api/query/content#html) (when getting HTML)
- [`attr()`](/docs/api/query/attributes#attr) (when getting an attribute)
- [`hasClass()`](/docs/api/query/css#hasclass)
- [`is()`](/docs/api/query/utilities#is)
- [`get()`](/docs/api/query/utilities#get)
...
- [Working with Shadow DOM](/docs/guides/query/shadow-dom)
- [Using Query within Components](/docs/guides/query/components)
- [Browser usage](/docs/guides/query/browser)
