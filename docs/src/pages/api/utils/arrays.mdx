...
Sort an array of objects by one or more keys. Supports multi-key sorting by passing an array of keys, and uses proper internationalized string comparison.
...
console.log(sortBy(people, 'age', (a, b) => b - a));
...
console.log(sortBy(employees, ['age', 'name']));
// [
//   { name: 'Alice', age: 25, department: 'IT' },
//   { name: 'Jane', age: 25, department: 'HR' },
//   { name: 'Bob', age: 30, department: 'IT' },
...
// Sort with custom comparator for multi-key
console.log(sortBy(employees, ['age', 'name'], (a, b, objA, objB, keyIndex) => {
  // Reverse sort for age (first key), normal sort for name (second key)
...
const arr2 = [3, 4, 5, 6];
const arr3 = [3, 4, 6, 7];
console.log(intersection(arr1, arr2, arr3)); // [3, 4]
```
...
const arr2 = [3, 4, 5, 6];
const arr3 = [3, 4, 6, 7];
console.log(difference(arr1, arr2, arr3)); // [1, 2]
```
...
const arr2 = [2, 3, 4];
const arr3 = [3, 4, 5];
console.log(uniqueItems(arr1, arr2, arr3)); // [1, 5]
```
