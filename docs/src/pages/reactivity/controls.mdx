...
Nonreactive lets you create a special enclosure where all reactivity will be ignored. This can let you reference several reactive sources without triggering reactivity.
