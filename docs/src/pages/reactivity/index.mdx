...
The reactivity system is implemented as a standalone package and can be used without adopting templating, components or other parts of Semantic UI components.

If you are using Semantic UI, reactivity is available natively from inside component lifecycle callbacks.
