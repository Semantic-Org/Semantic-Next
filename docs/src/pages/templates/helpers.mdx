...
## Helpers
Global helpers are special functions that can be used with [template expressions](templates/data) and provide common utilities when presenting content for display.
