...
This can be used with [helpers](/api/templates/helpers) like `numberFromIndex` to output non-zero indexed values.
...
[Global helpers](/api/templates/helpers) can be used to generate iterables like number ranges.
