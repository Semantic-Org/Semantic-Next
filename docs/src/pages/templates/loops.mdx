...
You can also use any JS to evaluate [expressions](/templates/expressions) in your data context
```sui
{#each [1, 2, 3]}
  {this}
{/each}
...
These [expressions](/templates/expressions) can also use variables
```sui
