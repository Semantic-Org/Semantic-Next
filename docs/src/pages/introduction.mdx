...
* A robust [reactive templating language](/api/templates) that compiles to web components.
...
For complex website and applications Semantic provides a full featured [web component framework](/components). This can be used to build your own custom UI using web components with the same toolkit used to build the UI library.
