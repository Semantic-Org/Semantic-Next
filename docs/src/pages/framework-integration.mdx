...
If you want to use Semantic UI Web Components directly in your page layouts without creating a custom design framework, you can import and use the components individually.

<Tabs>
<TabItem label="React">
In React, you can use web components directly since version 19, which introduced native support for web components. Simply import the desired component and use it in your JSX.
...
If you want to create a custom design framework that wraps multiple Semantic UI Web Components, you can create wrapper components that encapsulate the web components and provide a framework-specific API.
...
Alternatively, since React 19 introduced native support for web components, you can directly use the web components without the need for a wrapper component.
