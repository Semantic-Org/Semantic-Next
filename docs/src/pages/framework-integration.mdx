...
If you want to use Semantic UI Web Components directly in your page layouts without creating a custom design framework, you can import and use the components directly in layouts.
