...
* **createInstance** - Defines your [component instance](/component/instance) that includes the invokable functionality of your component and exposed variables.
...
For a more detailed description of how callbacks are fired refer to the [event sequence diagram](/components/lifecycle#event-sequence).

> **Render Function** Unlike many front end frameworks which require your render function to return the html for your component, your component's html is defined in the [template](/templates) passed to `createComponent`.
