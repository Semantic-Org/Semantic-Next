...
* **createInstance** - Defines your [component instance](/components/instances) that includes the invokable functionality of your component and exposed variables.
...
| self              | the template instance from createInstance             |
| tpl               | alias for self                                        |
