...
If dark mode is detected you can modify behaviors inside your component using the [lifecycle callback argument](/components/lifecycle#callback-arguments) `darkMode`.
