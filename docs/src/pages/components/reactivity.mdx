...
This guide focuses primarily on reactivity in the context of components, if you want to learn about how reactivity works generally check out the [reactivity package guide](/reactivity).
