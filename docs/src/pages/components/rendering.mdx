...
Your template instance stores methods and properties that implement the functionality of your component. You can access your template instance directly from [lifecycle events](/components/lifecycle) as `self` to invoke methods or access properties.
