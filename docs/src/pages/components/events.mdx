...
You can add special keywords to that modify how events are attached permitting you to bind events to elements other than those found in your [component's template](/templates).
