...
To create a new component in Semantic UI you pass in a set of arguments to `createComponent` which help define aspects of how your component functions. In the most simple case you only need to specify what HTML will be rendered for your component.
