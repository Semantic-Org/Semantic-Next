...
import { Button } from '@semantic-ui/core/components/button';
import { Icon } from '@semantic-ui/core/components/icon';
import '@semantic-ui/core/themes/button.css';
import '@semantic-ui/core/themes/icon.css';
...
export const Button = React.forwardRef((props, ref) => <ui-button ref={ref} {...props} />);
export const Icon = React.forwardRef((props, ref) => <ui-icon ref={ref} {...props} />);
```
#### Legacy React
...
export const Button = (props) => <WebComponentWrapper component="ui-button" {...props} />;
export const Icon = (props) => <WebComponentWrapper component="ui-icon" {...props} />;
```
</TabItem>
<TabItem label="Angular">
