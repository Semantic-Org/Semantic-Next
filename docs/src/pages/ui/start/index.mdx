...
- [Install Semantic UI](/ui/start/installation) in your project
- [Browse examples](/examples) to see what's possible
- Try the [interactive tutorial](/learn) to learn by doing
