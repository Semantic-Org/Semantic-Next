...
This is designed to make it easy to write code that binds reactively to data in a web component, allowing for reactive conditionals, partials with shared data contexts and much more.
