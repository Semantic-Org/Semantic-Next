...
In browser or stateless environments you can load the contents of html and css from separate files using the included helper [`getText`](/docs/api/utils/browser/#gettext). This will return the text value of an external file.
