...
Your data context includes a variety of sources that we'll cover in upcoming lessons, but to keep things simple this example lets uses the internal reactive data store `state`.
