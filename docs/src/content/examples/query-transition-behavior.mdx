...
description: 'Show and hide elements with CSS animations and @starting-style'
tags: ['query', 'plugin', 'behavior', 'animation', 'transition']
tip: 'Auto-detects visibility state from the DOM, so the same call shows or hides'
