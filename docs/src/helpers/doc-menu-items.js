...
export const sidebarMenuAPI = [
  ...
  },
  {
    ...
    icon: 'calendar',
    pages: [
      { name: 'Setup', url: '/docs/api/dates/setup' },
      { name: 'Reading Values', url: '/docs/api/dates/reading-values' },
      { name: 'Zones', url: '/docs/api/dates/zones' },
      ...
      { name: 'Time', url: '/docs/api/dates/time' },
      { name: 'Duration', url: '/docs/api/dates/duration' },
      { name: 'Ranges', url: '/docs/api/dates/ranges' },
      { name: 'Helpers', url: '/docs/api/dates/helpers' },
    ],
  },
  {
