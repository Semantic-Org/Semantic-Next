...
var S = (s4, o4) => {
  if (e)
    ...
    for (const e6 of o4) {
      ...
      void 0 !== n4 && o5.setAttribute("nonce", n4), o5.textContent = e6.cssText, s4.appendChild(o5);
    }
};
...
var b = class extends HTMLElement {
  ...
  static createProperty(t3, s4 = y) {
    if (s4.state && (s4.attribute = false), this._$Ei(), this.elementProperties.set(t3, s4), !s4.noAccessor) {
      const i6 = Symbol(), r5 = this.getPropertyDescriptor(t3, i6, s4);
      void 0 !== r5 && e2(this.prototype, t3, r5);
    }
  }
  static getPropertyDescriptor(t3, s4, i6) {
    const { get: e6, set: h3 } = r2(this.prototype, t3) ?? { get() {
      return this[s4];
    }, set(t4) {
      this[s4] = t4;
    } };
    return { get() {
      ...
      h3.call(this, s5), this.requestUpdate(t3, r5, i6);
  ...
  _$EO(t3, s4) {
    const i6 = this.constructor.elementProperties.get(t3), e6 = this.constructor._$Eu(t3, i6);
  ...
  _$AK(t3, s4) {
    const i6 = this.constructor, e6 = i6._$Eh.get(t3);
    if (void 0 !== e6 && this._$Em !== e6) {
      const t4 = i6.getPropertyOptions(e6), r5 = "function" == typeof t4.converter ? { fromAttribute: t4.converter } : void 0 !== t4.converter?.fromAttribute ? t4.converter : u;
      this._$Em = e6, this[e6] = r5.fromAttribute(s4, t4.type), this._$Em = null;
    }
  }
  requestUpdate(t3, s4, i6, e6 = false, r5) {
    if (void 0 !== t3) {
      if (i6 ??= this.constructor.getPropertyOptions(t3), !(i6.hasChanged ?? f)(e6 ? r5 : this[t3], s4))
        return;
      this.C(t3, s4, i6);
    }
  ...
  C(t3, s4, i6) {
    this._$AL.has(t3) || this._$AL.set(t3, s4), true === i6.reflect && this._$Em !== t3 && (this._$Ej ??= /* @__PURE__ */ new Set()).add(t3);
  }
  async _$EP() {
...
var y2 = (t3) => (i6, ...s4) => ({ _$litType$: t3, strings: i6, values: s4 });
var x = y2(1);
var b2 = y2(2);
      ...
      if (1 === r5.nodeType) {
        if (r5.hasAttributes())
          for (const t4 of r5.getAttributeNames())
            if (t4.endsWith(e3)) {
              const i6 = v2[a3++], s5 = r5.getAttribute(t4).split(h2), e6 = /([.?@])?(.*)/.exec(i6);
              d3.push({ type: 1, index: c4, name: e6[2], strings: s5, ctor: "." === e6[1] ? k : "?" === e6[1] ? H : "@" === e6[1] ? I : R }), r5.removeAttribute(t4);
            } else
        ...
        if ($.test(r5.tagName)) {
          ...
          if (s5 > 0) {
            ...
            for (let i6 = 0; i6 < s5; i6++)
              r5.append(t4[i6], l2()), E.nextNode(), d3.push({ type: 2, index: ++c4 });
            r5.append(t4[s5], l2());
          }
        }
...
function N(t3, i6, s4 = t3, e6) {
  if (i6 === w)
    return i6;
  let h3 = void 0 !== e6 ? s4._$Co?.[e6] : s4._$Cl;
  const o4 = c3(i6) ? void 0 : i6._$litDirective$;
  return h3?.constructor !== o4 && (h3?._$AO?.(false), void 0 === o4 ? h3 = void 0 : (h3 = new o4(t3), h3._$AT(t3, s4, e6)), void 0 !== e6 ? (s4._$Co ??= [])[e6] = h3 : s4._$Cl = h3), void 0 !== h3 && (i6 = N(t3, h3._$AS(t3, i6.values), h3, e6)), i6;
}
var S2 = class {
  constructor(t3, i6) {
  ...
  u(t3) {
    const { el: { content: i6 }, parts: s4 } = this._$AD, e6 = (t3?.creationScope ?? r3).importNode(i6, true);
    E.currentNode = e6;
    let h3 = E.nextNode(), o4 = 0, n4 = 0, l3 = s4[0];
    for (; void 0 !== l3; ) {
      if (o4 === l3.index) {
        let i7;
        2 === l3.type ? i7 = new M(h3, h3.nextSibling, this, t3) : 1 === l3.type ? i7 = new l3.ctor(h3, l3.name, l3.strings, this, t3) : 6 === l3.type && (i7 = new L(h3, this, t3)), this._$AV.push(i7), l3 = s4[++n4];
      }
...
var M = class _M {
  ...
  constructor(t3, i6, s4, e6) {
    this.type = 2, this._$AH = T, this._$AN = void 0, this._$AA = t3, this._$AB = i6, this._$AM = s4, this.options = e6, this._$Cv = e6?.isConnected ?? true;
  }
  get parentNode() {
  ...
  _$AI(t3, i6 = this) {
    t3 = N(this, t3, i6), c3(t3) ? t3 === T || null == t3 || "" === t3 ? (this._$AH !== T && this._$AR(), this._$AH = T) : t3 !== this._$AH && t3 !== w && this._(t3) : void 0 !== t3._$litType$ ? this.g(t3) : void 0 !== t3.nodeType ? this.$(t3) : u2(t3) ? this.T(t3) : this._(t3);
  }
  k(t3) {
  ...
  g(t3) {
    const { values: i6, _$litType$: s4 } = t3, e6 = "number" == typeof s4 ? this._$AC(t3) : (void 0 === s4.el && (s4.el = V.createElement(C(s4.h, s4.h[0]), this.options)), s4);
    if (this._$AH?._$AD === e6)
      this._$AH.p(i6);
    else {
      const t4 = new S2(e6, this), s5 = t4.u(this.options);
      t4.p(i6), this.$(s5), this._$AH = t4;
    }
  }
  _$AC(t3) {
    let i6 = A.get(t3.strings);
    return void 0 === i6 && A.set(t3.strings, i6 = new V(t3)), i6;
  }
  T(t3) {
  ...
  _$AR(t3 = this._$AA.nextSibling, i6) {
    for (this._$AP?.(false, true, i6); t3 && t3 !== this._$AB; ) {
...
var R = class {
  ...
  constructor(t3, i6, s4, e6, h3) {
    this.type = 1, this._$AH = T, this._$AN = void 0, this.element = t3, this.name = i6, this._$AM = e6, this.options = h3, s4.length > 2 || "" !== s4[0] || "" !== s4[1] ? (this._$AH = Array(s4.length - 1).fill(new String()), this.strings = s4) : this._$AH = T;
  }
  _$AI(t3, i6 = this, s4, e6) {
    const h3 = this.strings;
    let o4 = false;
    if (void 0 === h3)
      t3 = N(this, t3, i6, 0), o4 = !c3(t3) || t3 !== this._$AH && t3 !== w, o4 && (this._$AH = t3);
    else {
      const e7 = t3;
      let n4, r5;
      for (t3 = h3[0], n4 = 0; n4 < h3.length - 1; n4++)
        r5 = N(this, e7[s4 + n4], i6, n4), r5 === w && (r5 = this._$AH[n4]), o4 ||= !c3(r5) || r5 !== this._$AH[n4], r5 === T ? t3 = T : t3 !== T && (t3 += (r5 ?? "") + h3[n4 + 1]), this._$AH[n4] = r5;
    }
    o4 && !e6 && this.O(t3);
  }
  O(t3) {
...
var I = class extends R {
  constructor(t3, i6, s4, e6, h3) {
    super(t3, i6, s4, e6, h3), this.type = 5;
  }
  _$AI(t3, i6 = this) {
    if ((t3 = N(this, t3, i6, 0) ?? T) === w)
      return;
    const s4 = this._$AH, e6 = t3 === T && s4 !== T || t3.capture !== s4.capture || t3.once !== s4.once || t3.passive !== s4.passive, h3 = t3 !== T && (s4 === T || e6);
...
var j = (t3, i6, s4) => {
  ...
  if (void 0 === h3) {
    ...
    e6._$litPart$ = h3 = new M(i6.insertBefore(l2(), t4), t4, void 0, s4 ?? {});
  }
...
var s3 = class extends b {
  ...
  update(t3) {
    ...
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t3), this._$Do = j(i6, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
...
var e4 = (t3) => (...e6) => ({ _$litDirective$: t3, values: e6 });
var i4 = class {
  constructor(t3) {
  }
  get _$AU() {
  ...
  _$AT(t3, e6, i6) {
    this._$Ct = t3, this._$AM = e6, this._$Ci = i6;
  }
  _$AS(t3, e6) {
...
var i5 = e4(class extends i4 {
  ...
  update(t3, [s4, e6]) {
    if (Array.isArray(s4)) {
      if (Array.isArray(this.nt) && this.nt.length === s4.length && s4.every((r5, t4) => r5 === this.nt[t4]))
        return w;
    } else if (this.nt === s4)
      return w;
...
// src/lib/reactive/reactive-var.js
...
var LitRenderer = class {
  constructor({ ast, data: data2, litElement }) {
    this.ast = ast || "";
    this.data = data2 || {};
