...
var each = (obj, func, context) => {
  ...
  if (obj.length === +obj.length) {
    for (i4 = 0; i4 < obj.length; ++i4) {
      iteratee(obj[i4], i4, obj);
    }
  } else {
    let objKeys = keys(obj);
    for (i4 = 0; i4 < objKeys.length; ++i4) {
      iteratee(obj[objKeys[i4]], objKeys[i4], obj);
    }
  }
  return obj;
};
...
Button.template = `
  ...
  {{/if}}
`;
Button.onCreated = function(tpl, $3) {
  return {
    property: true,
    anotherProp: "1",
    getLove() {
...
var export_UIButton = void 0;
export {
  export_UIButton as UIButton
};
