(() => {
  ...
  function add_css(target) {
    append_styles(target, "svelte-1lexrcd", "@import url('./css/button.css');");
  }
  var get_icon_slot_changes = (dirty) => ({});
  var get_icon_slot_context = (ctx) => ({});
  var get_text_slot_changes = (dirty) => ({});
  var get_text_slot_context = (ctx) => ({ default: true });
  ...
  customElements.define("ui-button", create_custom_element(Button, {}, ["text", "icon"], [], true));
