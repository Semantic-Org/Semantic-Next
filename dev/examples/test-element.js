...
var S = (s6, o6) => {
  if (e)
    ...
    for (const e7 of o6) {
      ...
      void 0 !== n6 && o7.setAttribute("nonce", n6), o7.textContent = e7.cssText, s6.appendChild(o7);
    }
};
...
var b = class extends HTMLElement {
  ...
  _$AK(t5, s6) {
    ...
    if (void 0 !== e7 && this._$Em !== e7) {
      const t6 = i5.getPropertyOptions(e7), r7 = "function" == typeof t6.converter ? { fromAttribute: t6.converter } : void 0 !== t6.converter?.fromAttribute ? t6.converter : u;
      this._$Em = e7, this[e7] = r7.fromAttribute(s6, t6.type), this._$Em = null;
    }
  }
      ...
      if (1 === r7.nodeType) {
        if (r7.hasAttributes())
          for (const t6 of r7.getAttributeNames())
            if (t6.endsWith(e3)) {
              const i5 = v3[a3++], s7 = r7.getAttribute(t6).split(h2), e7 = /([.?@])?(.*)/.exec(i5);
              d3.push({ type: 1, index: c6, name: e7[2], strings: s7, ctor: "." === e7[1] ? k : "?" === e7[1] ? H : "@" === e7[1] ? I : R }), r7.removeAttribute(t6);
            } else
...
function N(t5, i5, s6 = t5, e7) {
  if (i5 === w)
    return i5;
  let h5 = void 0 !== e7 ? s6._$Co?.[e7] : s6._$Cl;
  const o6 = c3(i5) ? void 0 : i5._$litDirective$;
  return h5?.constructor !== o6 && (h5?._$AO?.(false), void 0 === o6 ? h5 = void 0 : (h5 = new o6(t5), h5._$AT(t5, s6, e7)), void 0 !== e7 ? (s6._$Co ??= [])[e7] = h5 : s6._$Cl = h5), void 0 !== h5 && (i5 = N(t5, h5._$AS(t5, i5.values), h5, e7)), i5;
}
var S2 = class {
  constructor(t5, i5) {
  ...
  u(t5) {
    const { el: { content: i5 }, parts: s6 } = this._$AD, e7 = (t5?.creationScope ?? r3).importNode(i5, true);
    E.currentNode = e7;
    let h5 = E.nextNode(), o6 = 0, n6 = 0, l3 = s6[0];
    for (; void 0 !== l3; ) {
      if (o6 === l3.index) {
        let i6;
        2 === l3.type ? i6 = new M(h5, h5.nextSibling, this, t5) : 1 === l3.type ? i6 = new l3.ctor(h5, l3.name, l3.strings, this, t5) : 6 === l3.type && (i6 = new L(h5, this, t5)), this._$AV.push(i6), l3 = s6[++n6];
      }
...
var M = class _M {
  ...
  constructor(t5, i5, s6, e7) {
    this.type = 2, this._$AH = T, this._$AN = void 0, this._$AA = t5, this._$AB = i5, this._$AM = s6, this.options = e7, this._$Cv = e7?.isConnected ?? true;
  }
  get parentNode() {
  ...
  $(t5) {
    const { values: i5, _$litType$: s6 } = t5, e7 = "number" == typeof s6 ? this._$AC(t5) : (void 0 === s6.el && (s6.el = V.createElement(C(s6.h, s6.h[0]), this.options)), s6);
  ...
  k(t5) {
    ...
    let s6, e7 = 0;
    for (const h5 of t5)
      e7 === i5.length ? i5.push(s6 = new _M(this.S(l2()), this.S(l2()), this, this.options)) : s6 = i5[e7], s6._$AI(h5), e7++;
...
var R = class {
  ...
  constructor(t5, i5, s6, e7, h5) {
    this.type = 1, this._$AH = T, this._$AN = void 0, this.element = t5, this.name = i5, this._$AM = e7, this.options = h5, s6.length > 2 || "" !== s6[0] || "" !== s6[1] ? (this._$AH = Array(s6.length - 1).fill(new String()), this.strings = s6) : this._$AH = T;
  }
  _$AI(t5, i5 = this, s6, e7) {
    ...
    if (void 0 === h5)
      ...
      for (t5 = h5[0], n6 = 0; n6 < h5.length - 1; n6++)
        r7 = N(this, e8[s6 + n6], i5, n6), r7 === w && (r7 = this._$AH[n6]), o6 ||= !c3(r7) || r7 !== this._$AH[n6], r7 === T ? t5 = T : t5 !== T && (t5 += (r7 ?? "") + h5[n6 + 1]), this._$AH[n6] = r7;
    }
    o6 && !e7 && this.j(t5);
  }
  j(t5) {
...
var I = class extends R {
  constructor(t5, i5, s6, e7, h5) {
    super(t5, i5, s6, e7, h5), this.type = 5;
  }
  _$AI(t5, i5 = this) {
...
var j = (t5, i5, s6) => {
  const e7 = s6?.renderBefore ?? i5;
  let h5 = e7._$litPart$;
  if (void 0 === h5) {
    const t6 = s6?.renderBefore ?? null;
    e7._$litPart$ = h5 = new M(i5.insertBefore(l2(), t6), t6, void 0, s6 ?? {});
  }
...
var last = function(array, n6, guard) {
  ...
  if (!n6 || guard) {
    ...
    return slice.call(array, Math.max(array.length - n6, 0));
  }
};
var range = (start, stop, step = 1) => {
  ...
  return Array(length).fill().map((x2, index) => {
...
var r5 = (o6, i5, n6) => {
  const e7 = o6._$AA.parentNode, l3 = void 0 === i5 ? o6._$AB : i5._$AA;
  if (void 0 === n6) {
    const i6 = e7.insertBefore(s4(), l3), c6 = e7.insertBefore(s4(), l3);
    n6 = new t4(i6, c6, o6, o6.options);
  } else {
    const t5 = n6._$AB.nextSibling, i6 = n6._$AM, c6 = i6 !== o6;
    if (c6) {
      let t6;
      n6._$AQ?.(o6), n6._$AM = o6, void 0 !== n6._$AP && (t6 = o6._$AU) !== i6._$AU && n6._$AP(t6);
    }
    if (t5 !== l3 || c6) {
      let o7 = n6._$AA;
      for (; o7 !== t5; ) {
        const t6 = o7.nextSibling;
        e7.insertBefore(o7, l3), o7 = t6;
      }
    }
  }
  return n6;
...
function n4(i5, t5 = false, e7 = 0) {
  const r7 = this._$AH, h5 = this._$AN;
  if (void 0 !== h5 && 0 !== h5.size)
    if (t5)
      if (Array.isArray(r7))
        for (let i6 = e7; i6 < r7.length; i6++)
...
var f4 = class extends i4 {
  ...
  _$AT(i5, t5, e7) {
    super._$AT(i5, t5, e7), r6(this), this.isConnected = i5._$AU;
  }
  _$AO(i5, t5 = true) {
...
var Query = class _Query {
  ...
  on(event, targetSelectorOrHandler, handler, abortController = new AbortController()) {
    ...
    Array.from(this).forEach((el) => {
      const eventListener = (e7) => {
        if (typeof targetSelectorOrHandler === "function") {
          targetSelectorOrHandler.call(el, e7);
        } else {
          for (let target = e7.target; target && target !== el; target = target.parentNode) {
            if (target.matches(targetSelectorOrHandler)) {
              handler.call(target, e7);
              break;
            }
          }
        }
    ...
    for (; x2 <= j2 && k2 <= w2; )
      if (null === d3[x2])
        ...
        if (m3.has(h5[j2])) {
          ...
          if (null === t6) {
            const e8 = r5(s6, d3[x2]);
            v2(e8, p4[k2]), v3[k2] = e8;
          } else
            v3[k2] = v2(t6, p4[k2]), r5(s6, d3[x2], t6), d3[e7] = null;
          k2++;
        } else
          h3(d3[j2]), j2--;
      else
...
var LitTemplate = class UITemplate {
  ...
  constructor({
    ...
    this.subTemplates = subTemplates;
    this.createInstance = createInstance4;
  ...
  attachEvents(events4 = this.events) {
    ...
    each(events4, (eventHandler, eventString) => {
...
var createComponent = ({
  ...
  tagName,
  events: events4 = {},
  createInstance: createInstance4 = noop,
  onCreated: onCreated2 = noop,
  onRendered: onRendered2 = noop,
  onDestroyed: onDestroyed3 = noop,
...
var test_element_default = `<div class="test-element">
  ...
  <div class="{{maybeActive 'events'}} tab" data-tab="events">
    Events & Reactivity
  </div>

  <p>This is the parent template context.</p>
...
// examples/test-element/test-element.css
var test_element_default2 = ".tab {\n  cursor: pointer;\n  display: inline-block;\n  border: 1px solid #DDD;\n  border-radius: 3px;\n  padding: 5px;\n  margin-right: 3px;\n}\n.tab:hover {\n  background-color: #DADADA;\n}\n\n.tab.active {\n  background-color: #DDD;\n}\n\n.number {\n  animation: alert 0.5s ease;\n  will-change: background;\n}\n@keyframes alert {\n  from {\n    background-color: red;\n  }\n  to {\n    background-color: white;\n  }\n}\n";

// examples/test-element/tabs/basic.html
var basic_default = `<button>Test button</button>
<h4>Default Slot Content</h4>
{{slot}}

<h4>Data Context</h4>
<ul>
  <li>Morning - {{morning}}</li>
  <li>Afternoon - {{afternoon}}</li>
  <li>Evening - {{evening}}</li>
</ul>
...
<h4>Data Context</h4>
<p>Referencing parent template</p>
<p>{{callParentMethod}} - {{parent.getText}}</p>

<h4>Reactive Computations & Helpers</h4>
<p>Today's date is {{formatDate}}, the exact time is <span>{{formatDateTimeSeconds date}}</span></p>
<p>
  Slogan for
  <b>{{second}} second{{maybePlural second}} is "{{slogan}}"</b>
</p>

<h4>Escaping HTML</h4>
<p>This is escaped:</p>
<p>{{getFormattedText}}</p>
<p>This is unescaped:</p>
<p>{{{getFormattedText}}}</p>

<hr>
<h4>Named Slot "Text"</h4>
<p>Text slot is "{{slot text}}"</p>
<p>Add a <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/slot" target="_blank">slot element</a> with name text to have it appear here.</p>
...
// examples/test-element/tabs/basic.css
var basic_default2 = ".red {\n  background-color: red;\n}\n.blue {\n  background-color: blue;\n}\n";

// examples/test-element/tabs/basic.js
var createInstance = (tpl, $3) => ({
  date: new ReactiveVar(/* @__PURE__ */ new Date()),
  ...
  setCurrentDate() {
    tpl.date.value = /* @__PURE__ */ new Date();
  },
  callParentMethod() {
...
var onRendered = (tpl) => {
  tpl.setCurrentDate();
  tpl.interval = setInterval(tpl.setCurrentDate, 1e3);
...
var basicTab = createComponent({
  templateName: "basic",
  createInstance,
  template: basic_default,
  css: basic_default2,
...
// examples/test-element/tabs/events.html
var events_default = '<h4>Events</h4>\n<p>\n  Enter a number\n  <input type="text" name="number" value="{{number}}" maxlength="4">\n  <button class="set">Set number to 5</button>\n</p>\n\n<hr>\n<h4>Reactive Updates</h4>\n<p>Number is {{number}}</p>\n\n<hr>\n<h4>Reactive conditions</h4>\n{{#if greaterThan number 100}}\n  Number is greater than 100\n{{else if greaterThan number 10}}\n  Number is greater than 10\n{{else if greaterThan number 0}}\n  Number is between 1-10\n  {{#if is number 5}}\n    Number is 5\n  {{else if not greaterThan number 5}}\n    Number is between 1-5\n  {{/if}}\n{{else if isNumber number}}\n  Number is {{number}} which is not between 1-1000.\n{{else}}\n  Value is not a number "{{number}}"\n{{/if}}\n\n<hr>\n\n<h4>People Looping</h4>\n{{#each person in persons}}\n  <li>\n    <input type="checkbox" id="{{person._id}}">\n    <label for="{{person._id}}">\n      {{person.name}} - Age {{person.age}}\n    </label>\n  </li>\n{{/each}}\n<button class="add front">Add Front</button>\n<button class="add end">Add End</button>\n<button class="remove front">Remove Front</button>\n<button class="remove end">Remove End</button>\n<button class="replace second">Replace Second</button>\n\n<h4>Input Looping</h4>\n{{#if number}}\n  {{#each countNumber in getRange number}}\n    <span class="number">{{countNumber}}</span>\n  {{/each}}\n{{else}}\n  {{number}} is not a valid number\n{{/if}}\n\n\n';

// examples/test-element/tabs/events.js
...
var events2 = {
  'input input[type="text"]'(event, tpl, $3) {
    tpl.number.value = $3(this).value();
  },
  "click .set"(event, tpl, $3) {
    tpl.number.value = 5;
    $3("input").value(5);
  },
...
var eventsTab = createComponent({
  templateName: "events",
  template: events_default,
  createInstance: createInstance2,
  events: events2
});

// examples/test-element/test-element.js
var createInstance3 = function(tpl, $3) {
  return {
...
var onDestroyed2 = (tpl) => {
};
var events3 = {
  "click .tab"(event, tpl, $3, data) {
...
var TestElement = createComponent({
  tagName: "test-element",
  template: test_element_default,
  css: test_element_default2,
