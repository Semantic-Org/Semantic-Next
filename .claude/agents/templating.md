...
2. **Template System Architecture**
   ...
   - `ai/guides/html-css-style-guide.md` - HTML structure conventions and CSS integration
...
5. **Template Integration Context**
   - `ai/guides/component-generation-instructions.md` - How templates integrate with components
