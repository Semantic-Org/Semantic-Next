/*
  Builds renderer bench files into self-contained bundles for CI
  comparison. Mirrors the pattern in
  packages/component/bench/tachometer/build-ci.js.
...
const benchFiles = ['bench-renderer-micros.js'];
