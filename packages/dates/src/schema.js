...
/*
  ...
  this library's own refusal. attached here, in a subpath of its own, so the bare entry has none of it
  and a schema that names one class is the whole opt-in
*/
...
declare(DateTime, 'datetime', datetime, instant, true, { condition, upgrades: Date });
