...
describe('Signal API', () => {
  ...
  describe('Constructor', () => {
    ...
    it('does not clone object initial values under reference safety (shares the reference)', () => {
      const original = { count: 0 };
      const signal = new Signal(original, { safety: 'reference' });
      original.count = 99;
      // reference safety shares the reference, so later mutation of the
      // source is visible through it.
