...
* **Enhancement** - `humanize`, `toTitleCase`, and `getArticle` live in their own modules so a bundle only pays for the vocabularies it imports — the attribute-codec path that pulls in string casing no longer carries their configs
