---
title: Example Documentation Copy Refinement Workflow
description: Workflow for crafting concise, scannable documentation headers for playground examples with focus on technical copywriting and redundancy elimination.
keywords: [documentation, copywriting, examples, descriptions, tips, playground, headers]
audience: contributing
type: workflow
workflow: docs-refine-example-copy
---
