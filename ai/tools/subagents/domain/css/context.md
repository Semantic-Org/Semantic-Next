...
Follow the principles outlined in `ai/guides/styling/css-guide.md`:
...
### Key Techniques
Refer to `ai/guides/styling/css-guide.md` for detailed patterns:
...
- **Hardcoded Values**: "Why not use fixed colors/sizes?"
  - **Response**: "Hardcoded values break theme adaptation and customization. Use tokens as defined in `ai/guides/styling/css-guide.md`"
...
### Token Compliance
- [ ] All styling follows `ai/guides/styling/css-guide.md` token-first approach
...
```json
{
  "handoff_context": {
    ...
    "recommendations": ["Verify patterns match ai/guides/styling/css-guide.md"]
  }
}
```
