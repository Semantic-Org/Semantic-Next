...
- AGENTS.md
- ai/tools/subagents/shared-context.md
- ai/tools/subagents/[domain|process]/[agent_name]/context.md
...
3. RETURN: Provide structured output per ai/tools/subagents/output-spec.md with handoff context for next agent
...
- AGENTS.md
- ai/tools/subagents/shared-context.md
- ai/tools/subagents/process/testing/context.md
- Complete ALL mandatory context loading instructions listed there
