---
title: Semantic UI HTML Guide
description: Canonical patterns for writing semantic, maintainable HTML with natural language class naming, role-based structures, and accessibility integration.
keywords: [HTML, semantic markup, class naming, accessibility, ARIA, data attributes, DOM structure]
audience: framework
type: doc
---
...
**Related guides:**
- **CSS patterns**: See `ai/guides/styling/css-guide.md` for CSS nesting and architecture
- **Primitive usage**: See `ai/guides/primitives.md` for using existing UI primitives
- **Design tokens**: See `ai/guides/styling/tokens/token-usage.md` for styling tokens
