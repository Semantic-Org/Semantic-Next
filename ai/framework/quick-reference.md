---
title: Semantic UI Quick Reference
description: Complete API reference for Semantic UI including component definition, state management, template syntax, event handling, query methods, and common recipes.
keywords: [API reference, quick reference, defineComponent, state, events, templates, query]
audience: framework
type: doc
---
