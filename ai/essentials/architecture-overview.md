...
keywords: [architecture, signals, reactivity, web components, shadow DOM, templates, defineComponent, callback pattern]
audience: essentials
skill: architecture-overview
---

# Semantic UI Architecture Overview

> **Skill:** `sui:architecture-overview`
> **Purpose:** Core mental model for AI agents working with Semantic UI, covering component architecture, reactivity system, template syntax, and framework design patterns.
...
|-------|---------|-------------|
| **Reactive State** | `sui:reactive-state` | Deep dive into signals, reactions, reactive state |
| **Component Specs** | `sui:component-specs` | Defining component APIs declaratively |
| **Design Tokens** | `sui:design-tokens` | Available design tokens for styling |
