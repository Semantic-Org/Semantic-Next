---
title: Adding a New Query Method
description: Complete workflow for implementing new Query class methods, including implementation patterns, testing, TypeScript definitions, documentation, and release notes.
