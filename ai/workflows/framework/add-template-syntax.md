---
title: Adding New Template Syntax
description: Complete workflow for implementing new template syntax features including compiler parsing, renderer evaluation, directive creation, and documentation.
