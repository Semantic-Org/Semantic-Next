---
title: Add AI Context Documentation Workflow
description: Workflow for publishing new AI context guides, including preflight analysis, authoring standards, and manifest integration.
keywords: [AI context, documentation, workflow, manifest, context guides]
