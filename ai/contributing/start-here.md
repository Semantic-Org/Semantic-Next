---
title: Semantic UI AI Documentation Hub
description: Central navigation hub for AI agents working with the Semantic UI web component framework, providing task routing, context loading strategies, and documentation structure.
keywords: [navigation, task routing, context loading, documentation hub, AI agents, workflows]
...
**Start with:** [Component Generation Guide](/ai/framework/creating-components.md)
...
**Start with:** [Example Authoring Guide](/ai/contributing/documentation/examples/authoring.md)
...
**Start with:** [Packages Directory](/ai/framework/)
...
**Start with:** [`framework/mental-model.md`](./framework/mental-model.md)
...
**Start with:** [`framework/quick-reference.md`](./framework/quick-reference.md)
...
**Start with:** [Component Authoring Best Practices](/ai/framework/best-practices.md)
...
**Start with:** [Testing Guide](/ai/contributing/development/testing.md)
...
**Start with:** [TypeScript Types Guide](/ai/contributing/development/typescript-types.md)
...
**Start with:** [Build System Guide](/ai/contributing/development/build-system.md)
...
**Start with:** [Code Formatting Guide](/ai/contributing/development/code-formatting.md)
...
**Start with:** [HTML Guide](/ai/framework/html.md) • [CSS Guide](/ai/framework/css.md) • [Theming](/ai/framework/theming.md) • [CSS Tokens](/ai/framework/design-tokens.md)
...
**Start with:** [Reactivity Package](/ai/framework/reactivity.md)
...
**Start with:** [Query Package](/ai/framework/query.md)
...
**Start with:** [Utils Package](/ai/framework/utils.md)
**Contains:** Complete utility library reference, performance patterns

### Workflow Decision Tree
Choose the workflow that matches your task:

- **Need to scaffold a new UI primitive?** → [`/ai/contributing/workflows/scaffold-primitive.md`](/ai/contributing/workflows/scaffold-primitive.md)
- **Need a new or updated component spec?** → [`/ai/contributing/workflows/define-primitive-spec.md`](/ai/contributing/workflows/define-primitive-spec.md)
- **Implement CSS from an approved spec?** → [`/ai/contributing/workflows/implement-primitive-css.md`](/ai/contributing/workflows/implement-primitive-css.md)
- **Add or enhance a package utility function?** → [`/ai/contributing/workflows/add-util-function.md`](/ai/contributing/workflows/add-util-function.md)
- **Create or refine documentation examples?** → [`/ai/contributing/workflows/refine-example-documentation-copy.md`](/ai/contributing/workflows/refine-example-documentation-copy.md)
- **Introduce new template syntax?** → [`/ai/contributing/workflows/add-template-syntax.md`](/ai/contributing/workflows/add-template-syntax.md)
- **Add Query package methods?** → [`/ai/contributing/workflows/add-query-method.md`](/ai/contributing/workflows/add-query-method.md)
- **Publish a new AI context guide?** → [`/ai/contributing/workflows/add-ai-context.md`](/ai/contributing/workflows/add-ai-context.md)

### Following Workflows
**Need to:** Step-by-step processes for specific tasks
**Start with:** [Workflows Directory](/ai/contributing/workflows/)
...
1. [Mental Model](/ai/framework/mental-model.md) - Core concepts and philosophy
2. [Component Generation Guide](/ai/framework/creating-components.md) - Component creation patterns
3. [Quick Reference](/ai/framework/quick-reference.md) - API reference

### **Component Development Context**
Context for building components for any application:
1. [Component Generation Guide](/ai/framework/creating-components.md) - Framework usage and architecture patterns
2. [Component Patterns Cookbook](/ai/framework/best-practices.md) - Communication and state patterns
3. [HTML Guide](/ai/framework/html.md) + [CSS Guide](/ai/framework/css.md) - Markup and styling conventions
...
1. [Example Authoring Guide](/ai/contributing/documentation/examples/authoring.md) - Complete example metadata system and docs requirements
2. [Package Documentation](/ai/framework/) - Package API demonstrations and references
3. [Component Generation Guide](/ai/framework/creating-components.md) - Component implementation patterns

### **Advanced Architecture Context**
Context for complex implementation and debugging:
1. [Mental Model](/ai/framework/mental-model.md) - Deep architectural understanding
2. [Component Patterns Cookbook](/ai/framework/best-practices.md) - Advanced patterns and anti-patterns
3. [Reactivity Package](/ai/framework/reactivity.md) - Reactive programming
4. [Query Package](/ai/framework/query.md) - DOM manipulation

### **Standalone Package Context**
Context for using individual packages outside the framework:
1. [Reactivity Package](/ai/framework/reactivity.md) - Independent reactive state
2. [Query Package](/ai/framework/query.md) - Shadow DOM-aware querying
3. [Utils Package](/ai/framework/utils.md) - Utility functions
4. [Templating Package](/ai/framework/templating.md) - Template system
5. [Specs Package](/ai/contributing/specs.md) - Component specifications
...
2. [`framework/quick-reference.md`](./framework/quick-reference.md) - Quick syntax lookup
...
| **/ai/contributing/development/testing.md** | Testing & QA | All levels | Guidelines + Patterns |
| **/ai/contributing/development/typescript-types.md** | TypeScript & JSDoc | All levels | Guidelines + Examples |
...
| **/ai/framework/css.md** | CSS Architecture | All levels | Guidelines + Examples |
...
├── Understand the concept → framework/mental-model.md
└── Look up API syntax → framework/quick-reference.md
...
└── State sharing → framework/mental-model.md (Component Tree Navigation)
...
Write or run tests?
├── Test organization → guides//ai/contributing/development/testing.md (Test Organization)
├── Choose test type → guides//ai/contributing/development/testing.md (Test Types)
├── Write tests → guides//ai/contributing/development/testing.md (Writing Tests)
└── Package-specific patterns → guides//ai/contributing/development/testing.md (Package-Specific Patterns)
...
### **Common Workflows**
- **Unknown Error:** foundations/codebase-navigation-guide.md → Find implementation → framework/mental-model.md for context
- **New Feature:** framework/mental-model.md → guides/components/creating-components.md → guides/components/component-authoring-best-practices.md
- **Code Review:** guides/components/component-authoring-best-practices.md → guides/styling/css-guide.md → framework/quick-reference.md

### **Search Strategy**
- Use foundations/codebase-navigation-guide.md for file locations
- Use framework/quick-reference.md for API signatures
- Use guides/components/component-authoring-best-practices.md for implementation examples
- Use framework/mental-model.md for "why" questions
...
│       ├── /ai/contributing/development/testing.md         ← Testing & QA
