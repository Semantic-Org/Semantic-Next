---
title: AI Agent Context Instructions
description: Guidelines for AI agents on optimizing documentation usage, context loading strategies, and navigation patterns for Semantic UI workflows.
keywords: [context loading, AI agents, documentation navigation, context optimization, task routing]
...
├── Read: `ai/framework/mental-model.md` (Core architectural concepts)
...
**Context:** [`guides/component-generation-instructions.md`](/ai/framework/creating-components.md)
**Supplementary:** [`framework/quick-reference.md`](/ai/framework/quick-reference.md) for API syntax

### Architecture Understanding
**Context:** [`framework/mental-model.md`](/ai/framework/mental-model.md)
**Supplementary:** [`guides/component-authoring-best-practices.md`](/ai/framework/best-practices.md) for implementation

### Debugging/Problem Solving
**Context:** [`foundations/codebase-navigation-guide.md`](/ai/contributing/codebase-navigation.md)
**Supplementary:** Source code files as identified

### Advanced Implementation
**Context:** [`guides/component-authoring-best-practices.md`](/ai/framework/best-practices.md)
**Supplementary:** [`packages/`](/ai/framework/) API documentation for specific packages
...
### Search Patterns
1.  **Unknown concepts** → framework/mental-model.md
2.  **Syntax lookup** → framework/quick-reference.md
