...
description: Technical architecture of the CSS token system, covering the two-context computation model, CSS layer ordering, variable resolution patterns, and extension guidelines.
