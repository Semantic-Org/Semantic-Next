---
title: Evaluate Research and Extend Spec
description: Workflow for presenting pattern research to the Semantic UI author for editorial decisions on extending component specifications based on adoption evidence.
keywords: [research, specs, editorial decisions, adoption levels, pattern evaluation, framework design]
