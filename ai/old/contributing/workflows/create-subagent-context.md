---
title: Agent Context Creation Workflow
description: Guide for creating specialized agent context files that enable domain-specific expertise within the Semantic UI multi-agent system architecture.
keywords: [agents, context, multi-agent, domain expertise, workflows, orchestration]
...
ai/framework/mental-model.md             (Core concepts and terminology)
```
