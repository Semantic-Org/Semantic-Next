---
title: Semantic UI Specs Package Guide
description: Guide to the @semantic-ui/specs package, covering declarative component metadata, spec file format, SpecReader API, shared terms system, and build pipeline integration.
keywords: [specs, component metadata, SpecReader, shared terms, spec files, build pipeline, documentation generation]
