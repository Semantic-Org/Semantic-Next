...
- [Bench Comment Truthfulness](active/bench-comment-truthfulness.md) — Tier 1 reporter fixes (peak filter, per-cell σ, suppression, copy rewrite, base-SHA fallback). Tier 2 amplification split out as a follow-up icebox plan.
---
