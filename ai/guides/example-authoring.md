...
> **Related:** [Component Development Guide](../guides/component-generation-instructions.md) • [HTML Guide](../guides/html-guide.md) • [CSS Token Guide](../guides/css-token-guide.md) • [Documentation Hub](../00-START-HERE.md)
...
1. **Check the CSS Token List Guide** at `/ai/guides/css-token-list.md` for complete reference
...
- **MANDATORY**: Read `/ai/guides/html-guide.md` for semantic HTML patterns
- **MANDATORY**: Read `/ai/guides/css-token-guide.md` for design token usage patterns
...
- **component.html**: Follow `/ai/guides/html-guide.md` - semantic classes, natural hierarchy
- **component.css**: Follow `/ai/guides/css-token-guide.md` - 100% design tokens, CSS nesting

#### Step 5: Page File Standards
- **page.css**: **MANDATORY** - Use only design tokens per `/ai/guides/css-token-guide.md`
- **page.html**: **MANDATORY** - Follow `/ai/guides/html-guide.md` semantic patterns
- **page.js**: Prefix query variables with `$` (`const $button = $('#btn')`)

### **Package Example Workflow**

#### Step 1: Research and Plan
- **MANDATORY**: Read `/ai/guides/css-token-guide.md` for design token usage
- **MANDATORY**: Read relevant package guide in `/ai/packages/` for API patterns
...
- **Semantic HTML**: Follow `/ai/guides/html-guide.md` patterns exactly
...
**CRITICAL**: Follow editorial standards from `/ai/workflows/refine-example-documentation-copy.md`
...
1. ✅ Read `/ai/guides/html-guide.md` for HTML patterns
2. ✅ Read `/ai/guides/css-token-guide.md` for CSS token usage
