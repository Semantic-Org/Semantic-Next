...
const TodoApp = () => {
  const [state, setState] = createLocalStore<TodoStore>({
    ...
    toggle = (todoId: number, { target: { checked } }: { target: HTMLInputElement; }) =>
    ...
    <section class='todoapp'>
      ...
      <Show when={state.todos.length > 0}>
        ...
        <footer class='footer'>
          ...
          <ul class='filters'>
            <li>
              <a href='#/' classList={{ selected: state.showMode === 'all' }}>All</a>
            </li>
            <li>
              <a href='#/active' classList={{ selected: state.showMode === 'active' }}>Active</a>
            </li>
            <li>
              <a href='#/completed' classList={{ selected: state.showMode === 'completed' }}>Completed</a>
            </li>
          </ul>
