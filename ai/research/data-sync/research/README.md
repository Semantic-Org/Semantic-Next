...
Three deep dossiers from live primary sources, each attacked by an independent adversarial review. Synthesis and ruling record at [`../reference-comparison.md`](../reference-comparison.md).
