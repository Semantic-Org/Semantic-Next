...
| 0:20–0:40 | CDN page: script tag, `subscribe('invoices')`, `{#each}` — no build, no endpoint. Two browsers, `psql UPDATE`, live within the poll interval |
