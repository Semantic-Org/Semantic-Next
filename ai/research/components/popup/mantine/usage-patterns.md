...
- **Semantic meaning**: Communicates supplementary or contextual content that appears on-demand relative to a trigger element, with full accessibility support and keyboard navigation
...
| Animation support | ✅ | Native | Transitions via Mantine's transition system (not explicitly shown but part of core) |
